...
SELECT GV.HOTEN, GV.LUONG
FROM GIAOVIEN GV
JOIN BOMON TBM ON GV.MABM = TBM.MABM
JOIN GIAOVIEN GVK ON TBM.TRUONGBM = GVK.MAGV
WHERE DATEDIFF(YEAR, GV.NGSINH, GVK.NGSINH) > 0
AND GV.NGSINH IS NOT NULL
AND GVK.NGSINH IS NOT NULL
